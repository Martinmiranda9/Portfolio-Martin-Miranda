          ...
          >
            ...
            {project.liveUrl && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-accent text-white hover:opacity-90 shadow-md hover:shadow-lg hover:shadow-accent/30 text-sm font-mono transition-all duration-300 active:scale-95"
              >
